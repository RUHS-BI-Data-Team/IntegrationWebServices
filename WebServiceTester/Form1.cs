...
namespace WebServiceTester
{
    public partial class Form1 : Form
    {
        ...
        private void btnOpenFile_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection cn = new SqlConnection("Data Source=cpc-intsqlprd01;Initial Catalog=HL7Data;Integrated Security=True; timeout= 120");
            ...
            {
                txtStartDate.Text = Convert.ToDateTime(txtStartDate.Text).AddDays(Convert.ToDouble(txtAmountDays.Text) * -1).ToString();
            }
