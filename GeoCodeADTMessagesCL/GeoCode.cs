...
namespace GeoCodeADTMessagesCL
{
    ...
    {
       public void AddPatientAddressToDB(GeoCodeResult PatientAddrerss, string MRN, string ControlId, DateTime HL7MessageDateTime, String ConnctionString)
        {
            if (PatientAddrerss.Easting > 100000 && PatientAddrerss.Northing > 100000 && MRN != "" && ControlId != "")
            {
                SqlConnection cn = new SqlConnection(ConnctionString);
